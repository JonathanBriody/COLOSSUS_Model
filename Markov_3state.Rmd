...
oncologySemiMarkov(l_params_all = l_params_all, n_wtp = 30000)
...
# cran.r-project.org/web/packages/dampack/vignettes/dsa_generation.html
  ...
  n_wtp            = 30000               # extra argument to pass to FUN to specify the willingness to pay
)
...
for(i_run in 1:n_runs){
  ...
  l_out_temp    <- oncologySemiMarkov(l_params_all = df_PA_input[i_run, ], n_wtp = 30000)
