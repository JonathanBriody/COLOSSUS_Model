...
# By multiplying by (1-the percent), we are discounting by that percentage.
...
u_AE1 <- AE1_discounted_daily_utility*7
u_AE2 <- AE2_discounted_daily_utility*7
u_AE3 <- AE3_discounted_daily_utility*7
