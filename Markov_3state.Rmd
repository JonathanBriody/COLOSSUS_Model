...
Results were remarkably similar to the deterministic analysis, per the probabilistic league table below [or else I could say, eith ICER of X, incremental costs of Y and incremental effectiveness of Y, i.e. describe the league table, but describe it in words], demonstrating the robustness of the model:
