...
#c_F_Exp<-c_F_Exp +p_FA1_STD*c_AE1 +p_FA2_STD*c_AE2 +p_FA3_STD*c_AE3


#u_F<-u_F-p_FA1_STD*u_AE1 -p_FA2_STD*u_AE2 -p_FA3_STD*u_AE3
...
v_tu_SoC <- m_M_SoC %*% c(u_F, u_P, u_D)
v_tu_Exp <- m_M_Exp %*% c(u_F, u_P, u_D)
