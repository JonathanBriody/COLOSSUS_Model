...
# Compare summary statistics: Compare the mean and variance of your data to the theoretical mean and variance of a gamma distribution. For a gamma distribution with parameters alpha and beta, the theoretical mean is alpha * beta and the variance is alpha * beta^2. 

# This is supported by: https://www.pnw.edu/wp-content/uploads/2020/03/Lecture-Notes-7.pdf saved here: C:\Users\Jonathan\OneDrive - Royal College of Surgeons in Ireland\COLOSSUS\Training Resources\Decision Modelling - Advanced Course\A2_Making Models Probabilistic\A2.1.2 Distributions for parameters\Lecture-Notes-7.pdf AND https://www.britannica.com/science/gamma-distribution AND https://real-statistics.com/other-key-distributions/gamma-distribution/

# If your sample mean and variance are close to these theoretical values, then your data might follow a gamma distribution.

# They can suggest if your data might follow a gamma distribution, but they can’t confirm it. Statistical tests like the Kolmogorov-Smirnov test or the Chi-Square goodness-of-fit test are needed for a more definitive check. 
