...
# If you wanted to compare to R files and see what the differences are between them, you can do so with this:

# install.packages("diffr")
# library(diffr)
# diffr("possible fix for cycle 1 being 1.R", "Markov_3state.Rmd", contextSize = 500, minJumpSize = 500, width = NULL)
# 
...
packages <- c("pacman", "flexsurv", "MASS", "dplyr", "devtools", "scales", "ellipse", "ggplot2", "lazyeval", "igraph", "ggraph", "reshape2", "knitr", "stringr", "diagram", "survival", "lubridate", "ggsurvfit", "gtsummary", "tidycmprsk", "magrittr", "dplyr")
...
# 1. Probability of an adverse event of given type
p_FA1_STD     <- 0.040   # probability of adverse event 1 when progression-free under SOC
p_FA2_STD     <- 0.310   # probability of adverse event 2 when progression-free under SOC
p_FA3_STD     <- 0.310   # probability of adverse event 3 when progression-free under SOC
...
BEFORE I CAN RUN THE SENSITIVITY ANALYSIS, I'LL NEED TO MAKE MY ADDITIONS ABOVE TO THE FUNCTION FOR SENSTIVIITY ANALYIS.

If I updated utility above re: adverse events, then I'll need to take this into account for u_F below:
...
l_params_all <- list(
  ...
  p_FD_SoC  = p_FD_SoC,
  p_FD_Exp  = p_FD_Exp,
  p_PFSD_SoC = p_PFSD_SoC,
  p_PFSD_Exp = p_PFSD_Exp,
  p_FA1_SoC = p_FA1_SoC,
  p_FA2_SoC = p_FA2_SoC,
  p_FA3_SoC = p_FA3_SoC,
  c_F_SoC   = c_F_SoC,  
...
If I updated utility for AEs above, then I'll have to take that into account for u_F below
