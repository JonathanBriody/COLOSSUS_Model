...
In a probabilistic sensitivity analysis (PSA) simultaneous samples were drawn from model parameters in Monte Carlo simulations, according to their sampling distributions.
Thus, joint uncertainty was propagated through the model over 10,000 replications.
...
Where this information was not available, model inputs were varied 20% above and below base case values.
