...
Here's how to generate the standard error (SE) for a log-normal distribution, and then to make random draws for a log-normal distribution: <https://hesim-dev.github.io/hesim/articles/markov-cohort.html>
