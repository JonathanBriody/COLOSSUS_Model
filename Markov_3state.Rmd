...
CHECK THINGS ARE BETWEEN 0 AND 1!
...
I HAVE NOT FILLED IN PROBABILTIES YET!

  P_OSD_SoC      = rbeta(n_runs, shape1 = 16, shape2 = 767),
  P_OSD_Exp      = rbeta(n_runs, shape1 = 22.4, shape2 = 201.6),
  p_FA1_STD = rbeta(n_runs, shape1 = 16, shape2 = 767),
  p_FA2_STD = rbeta(n_runs, shape1 = 22.4, shape2 = 201.6),
  p_FA3_STD = rbeta(n_runs, shape1 = 16, shape2 = 767),
  p_FA1_EXPR = rbeta(n_runs, shape1 = 22.4, shape2 = 201.6),
  p_FA2_EXPR = rbeta(n_runs, shape1 = 16, shape2 = 767),
  p_FA3_EXPR = rbeta(n_runs, shape1 = 22.4, shape2 = 201.6),
...
# This 20% approach is also taken by Lesley tilson and cited in her study and other studies here: https://trello.com/c/m653JBWV/48-20-cost-sensitivity
  ...
  administration_cost   = rgamma(n_runs, shape = 16, scale = 25), 
  c_PFS_Folfox   = rgamma(n_runs, shape = 16, scale = 50), 
  c_PFS_Bevacizumab       = rgamma(n_runs, shape = 100, scale = 10), 
  c_OS_Folfiri       = 0,
...
# If I wanted constant values for the discount rates I would have set them as above.
  THINK ABOUT THE DIVIDING BY 365 RULE HERE.
