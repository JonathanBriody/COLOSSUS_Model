...
In the absence of randomized controlled trials with a headto-head comparison between PK and BSA FOLFOX, we used results from one study to estimate survival for patients treated using a PK protocol and another to estimate survival for patients for whom dosing was determined based on BSA.
