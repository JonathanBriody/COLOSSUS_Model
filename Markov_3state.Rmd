...
# Save the plot
ggsave("Baseline_PFS_Curves_BothEXPANDSOC.png", width = 8, height = 6, dpi = 300)
...
# Save the plot
ggsave("Baseline_OS_Curves_BothEXPANDSOC.png", width = 8, height = 4, dpi = 300)
...
ggsave(paste("Tornado_Diagram_", country_name[1], ".png", sep = ""), plot = tornado_plot, width = 8, height = 4, dpi=300)
...
# Because I'm setting limits to put everything on the same range without actually knowing how these limits fit with the actual data, I create two versions on this plot, one with the limits applied, and one without the limits applied, so I can compare the two plots produced:
...
ggsave(paste("Unlimited_Tornado_Diagram_", country_name[1], ".png", sep = ""), plot = unlimited_tornado_plot, width = 8, height = 4, dpi=300)
while (!is.null(dev.list()))  dev.off()
...
ggsave(paste("CE_Scatter_Plot_", country_name[1], ".png", sep = ""), plot = ce_scatter_plot, width = 8, height = 4, dpi = 300)
...
ggsave(paste("Unlimited_CE_Scatter_Plot_", country_name[1], ".png", sep = ""), plot = unlimited_ce_scatter_plot, width = 8, height = 4, dpi = 300)
while (!is.null(dev.list())) dev.off()
...
# Save the plot to a file
ggsave(paste("CEAC_", country_name[1], ".png", sep = ""), plot = ceac_plot, width = 8, height = 4, dpi = 300)
...
# I create the Tornado Diagram once again, but this time I rename all the variables I include to make the diagram more legible:
