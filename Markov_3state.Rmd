...
p_FP_SoC
p_PFSD_SoC
p_FP_SoC <- p_FP_SoC - p_PFSD_SoC
p_FP_SoC

p_FP_Exp
p_PFSD_Exp
p_FP_Exp <- p_FP_Exp - p_PFSD_Exp
p_FP_Exp
...
# :Leukopenia = 0.040 Diarrhea = 0.310 Vomiting = 0.31
...
m_P_SoC["PFS", "PFS", ] <-   (1 - p_FA1_STD)* (1 - p_FA2_STD)* (1 - p_FA3_STD)* (1 - p_FP_SoC) * (1 - p_PFSD_SoC)
m_P_SoC["PFS", "AE1", ]     <- p_FA1_STD* (1 - p_FA2_STD)* (1 - p_FA3_STD)* (1 - p_FP_SoC) * (1 - p_PFSD_SoC)
m_P_SoC["PFS", "AE2", ]     <-  (1 - p_FA1_STD)* p_FA2_STD* (1 - p_FA3_STD)* (1 - p_FP_SoC) * (1 - p_PFSD_SoC)
m_P_SoC["PFS", "AE3", ]     <- (1 - p_FA1_STD)* (1 - p_FA2_STD)* p_FA3_STD* (1 - p_FP_SoC) * (1 - p_PFSD_SoC)
m_P_SoC["PFS", "OS", ]     <- (1 - p_FA1_STD)* (1 - p_FA2_STD)* (1 - p_FA3_STD)* p_FP_SoC* (1 - p_PFSD_SoC)
m_P_SoC["PFS", "Dead", ]            <-  (1 - p_FA1_STD)* (1 - p_FA2_STD)* (1 - p_FA3_STD)* (1 - p_FP_SoC) * (p_PFSD_SoC)
...
| Vomiting                                             | -0.36                 |               |               |        |              |
| **Hazard Ratios**                                    |                       |               |               |        |              |
| PFS to OS under the Experimental Strategy            | `HR_FP_Exp`           |               |               |        |              |
| OS to PFS under the Experimental Strategy            | `HR_PD_Exp`           |               |               |        |              |
