...
DSAICER <- DSAICER %>%
  mutate(parameter = case_when(
    parameter == "P_OSD_SoC" ~ "Probability Death Second Line Treatment - SoC",
    parameter == "P_OSD_Exp" ~ "Probability Death Second Line Treatment - Exp",
    parameter == "p_FA1_STD" ~ "Probability Leukopenia - SoC",
    parameter == "p_FA2_STD" ~ "Probability Diarrhea - SoC",
    parameter == "p_FA3_STD" ~ "Probability Nausea - SoC",
    parameter == "p_FA1_EXPR" ~ "Probability Leukopenia - Exp",
    parameter == "p_FA2_EXPR" ~ "Probability Diarrhea - Exp",
    parameter == "p_FA3_EXPR" ~ "Probability Nausea - Exp",
    ...
    parameter == "u_F" ~ "Utility First Line Treatment",
    parameter == "u_P" ~ "Utility Second Line Treatment",
    ...
    parameter == "HR_PD_SoC" ~ "Probability First Line - Death SoC",
    parameter == "HR_FP_SoC" ~ "Probability First - Second Line SoC",
    parameter == "HR_PD_Exp" ~ "HR First Line - Death Bev",
    parameter == "HR_FP_Exp" ~ "HR First - Second Line Treatment Bev",
