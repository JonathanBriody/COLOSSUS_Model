...
# Above is the cost for each state, healthy, sick and dead,

c_trtA    <- 800   # cost of treatment A (per cycle) in healthy state
c_trtB    <- 1500  # cost of treatment B (per cycle) in healthy state

# We make the cost of treatment above so that when we have treatment strategies we can add this cost of treatment to anyone whose being treated when they receive the treatment.
...
We initalise our structure below.
