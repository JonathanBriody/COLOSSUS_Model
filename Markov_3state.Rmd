...
[Per: [https://cran.r-project.org/web/packages/dampack/vignettes/psa_analysis.html]](https://cran.r-project.org/web/packages/dampack/vignettes/psa_analysis.html])
...
As as informed by [@briggs2012] we conduct a two-way sensitivity analysis for parameters expected to have a logical covariance.
