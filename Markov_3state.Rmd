...
write.csv(table_cea, file = paste0("Deterministic_ICER_For_", country_name, ".csv"), row.names = FALSE)
...
table_cea_PA
# Save the dataframe of the CEA table to a CSV file
write.csv(table_cea_PA, file = paste0("Probabilistic_ICER_For_", country_name, ".csv"), row.names = FALSE)
